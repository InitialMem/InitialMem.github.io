...
行高=高度，行高等于上下的padding加上文字的高度，文字的大小小于行高，上下的padding默认又是相等的，所以就会垂直居中
...
​	box-sizing: border-box/content-box;默认是content-box
...
为元素创建浮动框，使元素浮动到父级边缘或者另一个浮动框边缘，不会压住前面的标准流

1. 浮动元素不再占有原来的位置，脱离标准流**脱标**
